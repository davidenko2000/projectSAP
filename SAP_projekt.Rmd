...
```
Iz dobivenih histograma vidljivo je da postoje promjene u varijablama za različite godine, no raspodjela podataka je veoma slična za obe godine.
...
Pogledajmo sada distribuciju prirodnog logaritma bruto domaćeg proizvoda po stanovniku prema paritetu kupovne moći za nejednakost dohotka i nejednakost bogatstva.
```{r}
...
Izračunajmo sada srednje vrijednosti i medijane za nejednokost bogatsva po regijama
```{r}
library(tidyverse)
...
Najveća razlika srednje vrijednosti i medijana vidljiva je između Istočne Azije i Jugoistočne Azije. Postoje indikacije da je nejednakosti bogatsva veća u Jugoistočnoj Aziji u odnosu na Istočnu Aziju.
Postavimo sljedeće hipoteze:
H_0: Nejednakost bogatstva je jednaka u Istočnoj i Jugoistočnoj Aziji
H_1: Nejedankost bogatstva je veća u Jugoisočnoj Aziji u odnosu na Istočnu Aziju
...
```
Zbog male p-vrijednosti možemo odbaciti hipotezu H_0 u korist altternative da je nejednakost bogatstva u Jugoistočnoj Aziji u prosjeku veća od nejednakosti bogatstva u Istočnoj Aziji.
...
```
Zbog male p-vijednosti možemo odbaciti hiptezu H_0 da podaci dolaze iz normalne distibucije. Ne možemo provesiti t-test.
